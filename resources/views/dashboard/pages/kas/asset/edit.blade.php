        ...
        <form class="form-horizontal" method="POST">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control" type="text" name="id" value="{{$asset->id}}" readonly>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select name="kategori_id" id="kategori" class="form-control">
                            ...
                            <option value="{{$k->id}}" @if($k->id == $asset->kategori_id) selected @endif >{{$k->nama}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input name="nama" class="form-control" type="text" value="{{$asset->nama}}">
                    </div>
                </div>
                <div class="form-group">
