...
<script>
    ...
    function pilihProduk(item) {
        var template = `
            <tr id="tr-${index_transaksi}">
                <td>${item.kode}</td>
                <td>${item.nama}</td>
                <td style="text-align: right">${item.harga_jual_format}</td>
                ...
                <td style="text-align: right" id="tr-total-${index_transaksi}">${item.harga_jual_format}</td>
                ...
                <input id="tr-produk-harga-${index_transaksi}" type="hidden" name="produk[${index_transaksi}][harga]" value="${item.harga_jual}">
                <input id="tr-produk-total-${index_transaksi}" type="hidden" name="produk[${index_transaksi}][total]" value="${item.harga_jual}">
    ...
    $(function() {
                    ...
                    response = data.data.map(function(item) {
                            return {
                                ...
                                html: `<div class="row">` +
                                    ...
                                    `<strong>Harga</strong> : ${item.harga_jual_format} <br>` +
        ...
        $('#produk').on('select2:select', function(e) {
            ...
            if (selectedProduk.stok == 0) bootbox.alert('Stok Kosong')
            else pilihProduk(selectedProduk)
