        ...
        <form class="form-horizontal" method="POST" enctype="multipart/form-data">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control" type="text" name="id" value="{{$produk->id}}" readonly>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        @if($produk->foto)
                        <div id="gambar">
                            <img src="{{asset('public/'.$produk->foto)}}" class="img-thumbnail">
                            <br>
                            <br>
                            <button type="button" class="btn btn-warning" onclick="changeImage()">Ganti Gambar</button>
                        </div>
                        @endif
                        <div id="input-gambar" @if($produk->foto) style="display: none" @endif>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input name="kode" class="form-control" type="text" value="{{$produk->kode}}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="nama">Nama</label>
                    <div class="col-sm-5">
                        <input name="nama" class="form-control" type="text" value="{{$produk->nama}}">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select name="kategori_id" id="kategori" class="form-control">
                            ...
                            <option value="{{$k->id}}" @if($k->id == $produk->kategori_id) selected @endif >{{$k->nama}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input name="merk" class="form-control" type="text" value="{{$produk->merk}}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="warna">Warna</label>
                    <div class="col-sm-5">
                        <input name="warna" class="form-control" type="text" value="{{$produk->warna}}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="ukuran">Ukuran</label>
                    <div class="col-sm-5">
                        <input name="ukuran" class="form-control" type="text" value="{{$produk->ukuran}}">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input name="harga_beli" class="form-control currency-input" type="text" value="{{$produk->harga_beli_format}}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="harga_beli">Harga Jual</label>
                    <div class="col-sm-5">
                        <input name="harga_jual" class="form-control currency-input" type="text" value="{{$produk->harga_jual_format}}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="deskripsi">Deskripsi</label>
                    <div class="col-sm-5">
                        <textarea name="deskripsi" class="form-control" placeholder="Deskripsi" rows="4">{{$produk->deskripsi}}</textarea>
                    </div>
                </div>
            </div>
