<section class="content-header">
    <h1>
        ...
        <small>Edit Data Kategori Produk</small>
    </h1>
</section>
        ...
        <form class="form-horizontal" method="POST">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control" type="text" name="id" value="{{$produkkategori->id}}" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="nama">Nama</label>
                    <div class="col-sm-5">
                        <input name="nama" class="form-control" type="text" value="{{$produkkategori->nama}}">
                    </div>
                </div>
            </div>
